            ...
            <ul class="nofitications-dropdown">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#" class="grid">
                      <div class="user_img"><img src="images/avatar3.jpg" alt=""></div>
                      <div class="notification_desc">
              ...
              <li class="dropdown profile_details_drop">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                  ...
                  <div class="profile_img">
                    <img src="images/profileimg.jpg" class="rounded-circle" alt="" />
...
<div class="main-content">
  ...
  <div class="container-fluid content-top-gap">
    ...
    <script src="https://raw.githubusercontent.com/HubSpot/offline/v0.7.13/offline.min.js">
...
window.addEventListener('offline', () =>{ console.log('came offline');document.getElementById("con").style.display = "none";
});
    ...
    <span class="badge badge-success" id="con"  > vous etes connecte</span>
                  ...
                  <div class="inbox_chat">
                    <div class="chat_list active_chat">
                      <div class="chat_people">
                        <div class="chat_img"> <img src="images/avatar5.jpg" alt="Alexander" class="img-fluid">
                        </div>
                        <div class="chat_ib">
                    ...
                    <div class="chat_list">
                      <div class="chat_people">
                        <div class="chat_img"> <img src="images/avatar3.jpg" alt="Anderson" class="img-fluid">
                        </div>
                        <div class="chat_ib">
                    ...
                    <div class="chat_list">
                      <div class="chat_people">
                        <div class="chat_img"> <img src="images/avatar5.jpg" alt="Isabella" class="img-fluid">
                        </div>
                        <div class="chat_ib">
                    ...
                    <div class="chat_list">
                      <div class="chat_people">
                        <div class="chat_img"> <img src="images/avatar4.jpg" alt="Charlotte" class="img-fluid">
                        </div>
                        <div class="chat_ib">
                    ...
                    <div class="chat_list">
                      <div class="chat_people">
                        <div class="chat_img"> <img src="images/avatar2.jpg" alt="Davidson" class="img-fluid">
                        </div>
                        <div class="chat_ib">
                    ...
                    <div class="chat_list">
                      <div class="chat_people">
                        <div class="chat_img"> <img src="images/avatar1.jpg" alt="Elexa ker" class="img-fluid">
                        </div>
                        <div class="chat_ib">
                ...
                <div class="mesgs">
                  <div class="msg_history">
                    <div class="incoming_msg">
                      <div class="incoming_msg_img"> <img src="images/avatar5.jpg" alt="Alexander" class="img-fluid"> </div>
            ...
            <div class="messaging">
              <div class="inbox_msg">
                ...
                <div class="mesgs">
                  <div class="msg_history">
                    <div class="incoming_msg">
                      <div class="incoming_msg_img"> <img src="images/avatar5.jpg" alt="Alexander"
                          class="img-fluid"> </div>
                      <div class="received_msg">
                        <div class="received_withd_msg">
                          <p>Coming along nicely, we've got a Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  ...
                  <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-style" id="inputAddress2" placeholder="Apartment, studio, or floor">
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
...
$j(document).ready(function(){
  ...
  $j(
    ...
    var op = "min";
    if ($j(this).hasClass("date-picker-max")) {
      op = "max";
    }

    table2.columns().every(function() {
      var header = this.header();
      var date = $j(header).data("filter");
      if (date) {
        if (op === "min") {
          if (date < val) {
            this.visible(false);
...
<script src="js/scripts/bar.js"></script>
<script src="js/scripts/linechart.js"></script>
<!-- //Different scripts of charts.  Ex.Barchart, Linechart -->


<script src="js/scripts/jquery.nicescroll.js"></script>
